...
import NoContactsImage from '../utils/r2.png';
...
const Contacts = () => {
    ...
    <div className="m-auto w-fit p-4 align-middle text-blue-500 justify-center">
        <img className="m-auto" src={NoContactsImage} alt="No Contacts" />
        <h1 className="text-4xl">No Contact Found. Please add a contact using <br/>The Create Contact Button.</h1>
    </div>
)}
           <div className="m-4">
